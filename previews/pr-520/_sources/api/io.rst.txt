...
Pose construction optimizes hydrogens by default; the PDB compatibility wrapper
sets ``no_optH=True``. ``trust_hydrogen_names`` controls whether regenerated ligand
hydrogen names are compatible with supplied coordinates.
