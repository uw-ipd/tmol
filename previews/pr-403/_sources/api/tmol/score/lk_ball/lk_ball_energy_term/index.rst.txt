tmol.score.lk_ball.lk_ball_energy_term
======================================

.. py:module:: tmol.score.lk_ball.lk_ball_energy_term
...
.. autoapisummary::
   ...
   tmol.score.lk_ball.lk_ball_energy_term.LKBallEnergyTerm


Module Contents
---------------

.. py:class:: LKBallEnergyTerm(param_db: tmol.database.ParameterDatabase, device: torch.device)

   Bases: :py:obj:`tmol.score.atom_type_dependent_term.AtomTypeDependentTerm`, :py:obj:`tmol.score.hbond.hbond_dependent_term.HBondDependentTerm`
   ...
   .. py:attribute:: ljlk_global_params
      :type:  tmol.score.ljlk.params.LJLKGlobalParams


   .. py:attribute:: ljlk_param_resolver
      :type:  tmol.score.ljlk.params.LJLKParamResolver
   ...
   .. py:method:: pose_score_lk_ball(*args)


   .. py:method:: rotamer_score_lk_ball(*args)
