tmol.score.ljlk.ljlk_energy_term
================================

.. py:module:: tmol.score.ljlk.ljlk_energy_term
...
.. autoapisummary::
   ...
   tmol.score.ljlk.ljlk_energy_term.LJLKEnergyTerm


Module Contents
---------------

.. py:class:: LJLKEnergyTerm(param_db: tmol.database.ParameterDatabase, device: torch.device)

   Bases: :py:obj:`tmol.score.atom_type_dependent_term.AtomTypeDependentTerm`, :py:obj:`tmol.score.bond_dependent_term.BondDependentTerm`


   .. py:attribute:: type_params
      :type:  tmol.score.ljlk.params.LJLKTypeParams
