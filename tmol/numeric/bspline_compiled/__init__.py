_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "computeCoeffs2": ("compiled", "computeCoeffs2"),
    "computeCoeffs3": ("compiled", "computeCoeffs3"),
    "computeCoeffs4": ("compiled", "computeCoeffs4"),
    "interpolate2": ("compiled", "interpolate2"),
    "interpolate3": ("compiled", "interpolate3"),
    "interpolate4": ("compiled", "interpolate4"),
}
