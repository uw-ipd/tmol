...
import collections
import logging
from tmol.ligand._polymer_builder import adjacency
...
# Bond angle at the atom a terminal group hangs off when it is planar. The
#    database's patches carry the tetrahedral value instead, because an alpha
#    backbone's amide nitrogen is always sp3 once protonated.
_PLANAR_ANGLE = 120.0
...
def _with_every_added_atom(delta, variant, patch, chemistry):
    ...
    neighbours = adjacency(variant.bonds)
