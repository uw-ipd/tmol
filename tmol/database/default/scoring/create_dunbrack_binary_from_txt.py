...
def write_semi_rotameric_aa_dunbrack_library(
    aa3, nchi, bb_rotamer_lines, bbdep_density_lines, bbind_rotamer_def_lines, zgroup
):
...
def write_binary_version_of_dunbrack_rotamer_library(path_to_db_dir, out_path):
    nchi_for_aa = {
        "CYS": 1,
        "ASP": 2,
        "GLU": 3,
    ...
    for i, files in enumerate(lib_files):
        ...
        print("processing", files[0], files[1], files[2])
