...
def build_context_from_biotite(
    ...
    Args:
        ...
        prepare_ligands: Whether to detect/register ligands before conversion.
        ligand_ph: Protonation pH used for ligand preparation.
        param_db: Optional parameter database to mutate when preparing ligands.
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        param_db: Optional ParameterDatabase. When prepare_ligands=True,
            this is extended with ligand data. If None, uses a fresh DB.
...
def _populate_optional_atom_metadata(
    ...
    if hasattr(biotite_structure, "b_factor"):
        ...
        if n_poses == 1:
            ...
            for pose_ind in range(n_poses):
                biotite_b_factors[pose_ind, valid_res_inds, valid_atom_inds] = (
                    biotite_structure.b_factor[pose_ind][valid_atom_mask]
                )
        ...
        if n_poses == 1:
            ...
            for pose_ind in range(n_poses):
                biotite_occupancy[pose_ind, valid_res_inds, valid_atom_inds] = (
                    biotite_structure.occupancy[pose_ind][valid_atom_mask]
                )
...
def _paramdb_for_biotite() -> ParameterDatabase:
    ...
    return ParameterDatabase.get_current()
