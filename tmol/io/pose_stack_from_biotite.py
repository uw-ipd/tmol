...
def build_context_from_biotite(
    ...
    Args:
        ...
        param_db: Optional parameter database. When provided, canonical ordering,
            residue types, and packed block types are built from this database in
            both ligand and non-ligand paths.
    ...
    **kwargs: object,
    ...
    Args:
        ...
        param_db: Optional ParameterDatabase. When provided, conversion and pose
            ...
            extended with ligand data. If None, defaults are used (or a fresh DB
            when preparing ligands).
