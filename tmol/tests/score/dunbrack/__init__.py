_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "test_smoke": ("test_dunbrack_energy_term", "test_smoke"),
    "test_annotate_block_types": (
        "test_dunbrack_energy_term",
        "test_annotate_block_types",
    ),
    "TestDunbrackEnergyTerm": ("test_dunbrack_energy_term", "TestDunbrackEnergyTerm"),
}
