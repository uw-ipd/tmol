_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "test_smoke": ("test_lk_ball_energy_term", "test_smoke"),
    "test_annotate_restypes": ("test_lk_ball_energy_term", "test_annotate_restypes"),
    "test_whole_pose_scoring_module_smoke": (
        "test_lk_ball_energy_term",
        "test_whole_pose_scoring_module_smoke",
    ),
    "TestLKBallEnergyTerm": ("test_lk_ball_energy_term", "TestLKBallEnergyTerm"),
}
