...
def test_sp2_single_hbond():
    ...
    hbpoly_ahdist_aGLY_dGLY_9gt3_hesmooth_min1p6_bounds = torch.tensor([[1.1, 1.1]])
...
def test_sp3_single_hbond():
    ...
    hbpoly_ahdist_aSER_dGLY_9gt3_hesmooth_min1p6_bounds = torch.tensor([[1.1, 1.1]])
...
def test_ring_single_hbond():
    ...
    hbpoly_ahdist_aHIS_dGLY_9gt3_hesmooth_min1p6_bounds = torch.tensor([[1.1, 1.1]])
