_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "test_smoke": ("test_ljlk_energy_term", "test_smoke"),
    "test_annotate_heavy_ats_in_tile": (
        "test_ljlk_energy_term",
        "test_annotate_heavy_ats_in_tile",
    ),
    "TestLJLKEnergyTerm": ("test_ljlk_energy_term", "TestLJLKEnergyTerm"),
}
