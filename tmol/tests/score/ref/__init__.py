_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "test_smoke": ("test_ref_energy_term", "test_smoke"),
    "test_annotate_block_types": ("test_ref_energy_term", "test_annotate_block_types"),
    "TestRefEnergyTerm": ("test_ref_energy_term", "TestRefEnergyTerm"),
}
