...
def test_smoke(default_database, torch_device: torch.device):
    cartbonded_energy = CartBondedEnergyTerm(param_db=default_database, device=torch_device)
...
def test_annotate_twice(fresh_default_restype_set, default_database, torch_device):
    ...
    cartbonded_energy_cpu = CartBondedEnergyTerm(param_db=default_database, device=cpu_device)
    cartbonded_energy_device = CartBondedEnergyTerm(param_db=default_database, device=torch_device)
...
def test_annotate_restypes(fresh_default_packed_block_types, default_database, torch_device: torch.device):
    cartbonded_energy = CartBondedEnergyTerm(param_db=default_database, device=torch_device)
