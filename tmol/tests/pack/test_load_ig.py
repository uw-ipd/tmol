...
def construct_faux_rotamer_set_and_sparse_energies_table_from_ig(ig, pdb_fname, device):
    ...
    oneb, twob = ig  # load_ig_from_file(ig_fname)
...
def test_construct_rotamer_set_and_sparse_energies_table_from_ig(ubq_ig, torch_device):
    ...
    # print("rotamer_set.block_type_ind_for_rot",rotamer_set.block_type_ind_for_rot.shape)
    ...
    # print("rotamer_set2.n_rots_for_pose",       rotamer_set2.n_rots_for_pose.shape)
    # print("rotamer_set2.rot_offset_for_pose",   rotamer_set2.rot_offset_for_pose.shape)
    # print("rotamer_set2.n_rots_for_block",      rotamer_set2.n_rots_for_block.shape)
    # print("rotamer_set2.rot_offset_for_block",  rotamer_set2.rot_offset_for_block.shape)
    # print("rotamer_set2.pose_for_rot",          rotamer_set2.pose_for_rot.shape)
    # print("rotamer_set2.block_type_ind_for_rot",rotamer_set2.block_type_ind_for_rot.shape)
    # print("rotamer_set2.block_ind_for_rot",     rotamer_set2.block_ind_for_rot.shape)
    # print("sparse_indices2",                    sparse_indices2.shape)
    # print("energies2",                          energies2.shape)
...
#     oneb, restype_groups, twob = ubq_ig
#
