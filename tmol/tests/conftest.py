...
from .numba import numba_cuda_or_cudasim, numba_cudasim  # noqa: F401
...
from .torch import torch_backward_coverage, torch_device  # noqa: F401
...
def pytest_benchmark_update_machine_info(config, machine_info):
    ...
    machine_info["cuda"] = {
        ...
        "current_device": (torch.cuda.current_device() if torch.cuda.device_count() else None),
    }
