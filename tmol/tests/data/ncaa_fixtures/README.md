...
`chromophore_nrq_3svu.cif` retains model 1, label chain A residues 65–69
(SER–PHE–NRQ–SER–LYS) from the local 2026-01-06 PDB mirror's 3SVU entry.
Coordinates, component definitions and connections are unchanged; entity/sequence
categories are restricted to this fragment. NRQ's N1=CA1 acyl-imine endpoint
cannot borrow ordinary amine junction rows. Its generated cap length/angle
parameters must survive polymer reconstruction; otherwise the preceding peptide
bond collapses during minimization. The regression checks source bond order,
generated K300/K80 parameters, gradients and relaxed linkage geometry.
