            ...
            torch.stack(
                _t(
                    [
                        ...
                        global_params.dss_mixed_logA1,
                        global_params.dss_kappa1,
                        global_params.dss_mixed_kappa1,
                        global_params.dss_mu1,
                        global_params.dss_mixed_mu1,
                        global_params.dss_logA2,
                        global_params.dss_mixed_logA2,
                        global_params.dss_kappa2,
                        global_params.dss_mixed_kappa2,
                        global_params.dss_mu2,
                        global_params.dss_mixed_mu2,
