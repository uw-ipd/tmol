...
auto HBondPoseScoreDispatch<DeviceDispatch, Dev, Real, Int>::f(
  ...
  auto eval_energies_and_derivs = ([=] TMOL_DEVICE_FUNC(int cta) {
    auto hbond_atom_energy_and_derivs =
        ([=] TMOL_DEVICE_FUNC(
             int don_ind,
             int acc_ind,
             int don_tile_ind,
    ...
    auto score_inter_hbond_atom_pair =
        ([=] TMOL_DEVICE_FUNC(
          ...
          int don_tile_ind = (donor_first ? inter_dat.r1 : inter_dat.r2)
                                 .donH_tile_inds[don_ind];
          int acc_tile_ind = (donor_first ? inter_dat.r2 : inter_dat.r1)
                                 .acc_tile_inds[acc_ind];
    ...
    auto score_intra_hbond_atom_pair =
        ([=] TMOL_DEVICE_FUNC(
             ...
             bool donor_first) {
          int don_tile_ind = (donor_first ? intra_dat.r1 : intra_dat.r2)
                                 .donH_tile_inds[don_ind];
          int acc_tile_ind = (donor_first ? intra_dat.r2 : intra_dat.r1)
                                 .acc_tile_inds[acc_ind];
