_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "RefEnergyTerm": ("ref_energy_term", "RefEnergyTerm"),
    "eval_ref_energy_for_pose": ("ref_energy_term", "eval_ref_energy_for_pose"),
    "eval_ref_energy_for_rotamers": ("ref_energy_term", "eval_ref_energy_for_rotamers"),
}
