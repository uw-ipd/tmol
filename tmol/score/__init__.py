...
def beta2016_score_function(
    ...
    sfxn.set_weight(ScoreType.fa_ljatr, 1.0)  # bad
    sfxn.set_weight(ScoreType.fa_ljrep, 0.55)  # bad
    sfxn.set_weight(ScoreType.fa_lk, 1.0)  # bad

    # sfxn.set_weight(ScoreType.fa_elec, 1.0)

    # sfxn.set_weight(ScoreType.hbond, 1.0) #bad
