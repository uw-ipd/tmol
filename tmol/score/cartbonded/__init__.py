_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "debug": ("cartbonded_energy_term", "debug"),
    "CROSS_RES_PREFIX": ("cartbonded_energy_term", "CROSS_RES_PREFIX"),
    "CartBondedBlockAnnotations": (
        "cartbonded_energy_term",
        "CartBondedBlockAnnotations",
    ),
    "CartBondedPackedBlockTypesAnnotations": (
        "cartbonded_energy_term",
        "CartBondedPackedBlockTypesAnnotations",
    ),
    "CartBondedEnergyTerm": ("cartbonded_energy_term", "CartBondedEnergyTerm"),
}
