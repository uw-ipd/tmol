_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "LKBallEnergyTerm": ("lk_ball_energy_term", "LKBallEnergyTerm"),
    "LKBallBlockTypeParams": ("params", "LKBallBlockTypeParams"),
    "LKBallPackedBlockTypesParams": ("params", "LKBallPackedBlockTypesParams"),
}
