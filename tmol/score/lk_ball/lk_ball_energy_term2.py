...
class LKBallEnergyTerm2(AtomTypeDependentTerm, HBondDependentTerm):
    ...
    def __init__(self, param_db: ParameterDatabase, device: torch.device):
        super(LKBallEnergyTerm2, self).__init__(param_db=param_db, device=device)
        ...
        self.tile_size = LKBallEnergyTerm2.tile_size

    @classmethod
    def score_types(cls):
        import tmol.score.terms.lk_ball_creator2

        return tmol.score.terms.lk_ball_creator2.LKBallTermCreator2.score_types()
    ...
    def setup_block_type(self, block_type: RefinedResidueType):
        ...
        tile_size = LKBallEnergyTerm2.tile_size
    ...
    def render_whole_pose_scoring_module(self, pose_stack: PoseStack):
        ...
        return LKBallWholePoseScoringModule2(
