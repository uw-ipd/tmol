...
template <
    ...
    typename Real,
    typename Int>
class LKBallPoseScoreDispatch2 {
 public:
  static auto forward(
    ...
    auto eval_energies_only = ([=] TMOL_DEVICE_FUNC(int cta) {
      auto score_inter_lk_ball_atom_pair =
          ([=] TMOL_DEVICE_FUNC(
            ...
            lk_ball_Vt<Real> E = lk_ball_atom_energy_full2<MAX_N_WATER>(
                pol_ind,
                occ_ind,
                pol_tile_ind,
                occ_tile_ind,
      ...
      SHARED_MEMORY union shared_mem_union {
        shared_mem_union() {}
        LKBallBlockPairSharedData2<Real, TILE_SIZE, MAX_N_WATER, MAX_N_CONN> m;
      ...
      auto load_tile_invariant_interres_data =
          ([=](int pose_ind,
            ...
            lk_ball_load_tile_invariant_interres_data2<DeviceDispatch, Dev, nt>(
      ...
      auto load_interres1_tile_data_to_shared = ([=](int tile_ind,
                                                     ...
                                                     LKBallScoringData2<Real>
                                                         &inter_dat,
                                                     shared_mem_union &shared) {
        lk_ball_load_interres1_tile_data_to_shared2<DeviceDispatch, Dev, nt>(
            pose_coords,
            water_coords,
      ...
      auto load_interres2_tile_data_to_shared = ([=](int tile_ind,
                                                     ...
                                                     LKBallScoringData2<Real>
                                                         &inter_dat,
                                                     shared_mem_union &shared) {
        lk_ball_load_interres2_tile_data_to_shared2<DeviceDispatch, Dev, nt>(
            pose_coords,
            water_coords,
            block_type_tile_n_polar_atoms,
            block_type_tile_n_occluder_atoms,
      ...
      auto load_interres_data_from_shared =
          ([=](int, int, shared_mem_union &, LKBallScoringData2<Real> &) {});

      auto eval_interres_atom_pair_scores =
          ([=](LKBallScoringData2<Real> &inter_dat,
               int start_atom1,
               int start_atom2) {
            eval_interres_pol_occ_pair_energies_new<
                DeviceDispatch,
                Dev,
                nt,
                TILE_SIZE,
                MAX_N_WATER>(inter_dat, start_atom1, start_atom2);
          });

      auto store_calculated_energies =
          ([=](LKBallScoringData2<Real> &score_dat, shared_mem_union &shared) {
      ...
      auto load_tile_invariant_intrares_data =
          ([=](int pose_ind,
               ...
               LKBallScoringData2<Real> &intra_dat,
               shared_mem_union &shared) {
            lk_ball_load_tile_invariant_intrares_data2<DeviceDispatch, Dev, nt>(
                pose_stack_block_coord_offset,
                pose_stack_block_type,
                global_params,
                max_important_bond_separation,
      ...
      auto load_intrares1_tile_data_to_shared = ([=](int tile_ind,
                                                     ...
                                                     LKBallScoringData2<Real>
                                                         &intra_dat,
                                                     shared_mem_union &shared) {
        lk_ball_load_intrares1_tile_data_to_shared2<DeviceDispatch, Dev, nt>(
            pose_coords,
            water_coords,
            block_type_tile_n_polar_atoms,
            block_type_tile_n_occluder_atoms,
      ...
      auto load_intrares2_tile_data_to_shared = ([=](int tile_ind,
                                                     ...
                                                     LKBallScoringData2<Real>
                                                         &intra_dat,
                                                     shared_mem_union &shared) {
        lk_ball_load_intrares2_tile_data_to_shared2<DeviceDispatch, Dev, nt>(
            pose_coords,
            water_coords,
            block_type_tile_n_polar_atoms,
            block_type_tile_n_occluder_atoms,
      ...
      auto load_intrares_data_from_shared =
          ([=](int tile_ind1,
               ...
               shared_mem_union &shared,
               LKBallScoringData2<Real> &intra_dat) {
            lk_ball_load_intrares_data_from_shared2(
    ...
    auto eval_derivs = ([=] TMOL_DEVICE_FUNC(int cta) {
      auto lk_ball_atom_derivs =
          ([=] TMOL_DEVICE_FUNC(
               ...
               LKBallResPairData2<Real> const &respair_dat,
               int cp_separation) {
            // capture dTdV, dV_d_pose_coords, & dV_d_water_coords

            lk_ball_atom_derivs_full2<TILE_SIZE, MAX_N_WATER>(
                pol_ind,
                occ_ind,
                pol_tile_ind,
                occ_tile_ind,
      ...
      auto dscore_inter_lk_ball_atom_pair =
          ([=] TMOL_DEVICE_FUNC(
               ...
               int pol_ind,
               int occ_ind,
               LKBallScoringData2<Real> const &inter_dat,
               bool polar_first) {
            int pol_tile_ind = (polar_first ? inter_dat.r1 : inter_dat.r2)
                                   .pol_occ_tile_inds[pol_ind];
            int occ_tile_ind = (polar_first ? inter_dat.r2 : inter_dat.r1)
      ...
      auto dscore_intra_lk_ball_atom_pair =
          ([=] TMOL_DEVICE_FUNC(
               ...
               int pol_ind,
               int occ_ind,
               LKBallScoringData2<Real> const &intra_dat,
               bool polar_first) {
            int pol_tile_ind = (polar_first ? intra_dat.r1 : intra_dat.r2)
                                   .pol_occ_tile_inds[pol_ind];
            int occ_tile_ind = (polar_first ? intra_dat.r2 : intra_dat.r1)
      ...
      auto eval_interres_atom_pair_scores =
          ([=](LKBallScoringData2<Real> &inter_dat,
               int start_atom1,
               int start_atom2) {
            eval_interres_pol_occ_pair_energies2<DeviceDispatch, Dev, nt>(
                inter_dat,
                start_atom1,
                start_atom2,
