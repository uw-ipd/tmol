_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "BackboneTorsionBlockTypeParams": (
        "bb_torsion_energy_term",
        "BackboneTorsionBlockTypeParams",
    ),
    "BackboneTorsionPackedBlockTypesParams": (
        "bb_torsion_energy_term",
        "BackboneTorsionPackedBlockTypesParams",
    ),
    ...
    "PackedRamaDatabase": ("params", "PackedRamaDatabase"),
    "PackedOmegaDatabase": ("params", "PackedOmegaDatabase"),
    "BackboneTorsionParamResolver": ("params", "BackboneTorsionParamResolver"),
}
