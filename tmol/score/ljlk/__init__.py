_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    "LJLKEnergyTerm": ("ljlk_energy_term", "LJLKEnergyTerm"),
    "LJLKGlobalParams": ("params", "LJLKGlobalParams"),
    "LJLKTypeParams": ("params", "LJLKTypeParams"),
    "LJLKParamResolver": ("params", "LJLKParamResolver"),
}
