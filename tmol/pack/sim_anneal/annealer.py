...
class SelectRanRotModule(torch.jit.ScriptModule):
    def __init__(
        ...
        self.pose_id_for_context = _p(pose_id_for_context.to(torch.int64))
        self.n_rots_for_pose = _p(n_rots_for_pose.to(torch.int64))
        self.rot_offset_for_pose = _p(rot_offset_for_pose.to(torch.int64))
        self.block_type_ind_for_rot = _p(block_type_ind_for_rot.to(torch.int64))
        self.block_ind_for_rot = _p(block_ind_for_rot.to(torch.int64))
