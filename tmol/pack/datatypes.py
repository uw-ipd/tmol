...
class PackerEnergyTables(TensorGroup, ConvertAttrs):
    ...
    nrestype_groups_for_res: Tensor(torch.int32)[:] # [nres]
    ...
    twob_course_offsets: Tensor(torch.int64)[:,:] # [nres x nres]
    twob_fine_offsets: Tensor(torch.int64)[:] # [n_nonzero_submatrices]
