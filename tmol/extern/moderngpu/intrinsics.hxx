...
//fd : CUDA now supports double width shuffles (no special macro) and requires sync
...
MGPU_DEVICE type_t shfl_up(type_t x, int offset, int width = warp_size) { 
  ...
  iterate<num_words>([&](int i) {
    u.x[i] = __shfl_up_sync(-1, u.x[i], offset, width);
  });
  return u.t;
}
...
MGPU_DEVICE type_t shfl_down(type_t x, int offset, int width = warp_size) { 
  ...
  iterate<num_words>([&](int i) {
    u.x[i] = __shfl_down_sync(-1, u.x[i], offset, width);
  });
  return u.t;
}
...
#define SHFL_OP_MACRO(dir, is_up, ptx_type, nbits, r, c_type, ptx_op, c_op) \
MGPU_DEVICE inline c_type shfl_##dir##_op(c_type x, int offset, \
  ...
  asm( \
    "{.reg ."#ptx_type" r0;" \
    ".reg .pred p;" \
    "shfl.sync."#dir"."#nbits" r0|p, %1, %2, %3, -1;" \
...
SHFL_OP_MACRO(up, true, s32, b32, r, int, add, plus_t)
SHFL_OP_MACRO(up, true, s32, b32, r, int, max, maximum_t)
SHFL_OP_MACRO(up, true, s32, b32, r, int, min, minimum_t)
SHFL_OP_MACRO(down, false, s32, b32, r, int, add, plus_t)
SHFL_OP_MACRO(down, false, s32, b32, r, int, max, maximum_t)
SHFL_OP_MACRO(down, false, s32, b32, r, int, min, minimum_t)

SHFL_OP_MACRO(up, true, u32, b32, r, unsigned, add, plus_t)
SHFL_OP_MACRO(up, true, u32, b32, r, unsigned, max, maximum_t)
SHFL_OP_MACRO(up, true, u32, b32, r, unsigned, min, minimum_t)
SHFL_OP_MACRO(down, false, u32, b32, r, unsigned, add, plus_t)
SHFL_OP_MACRO(down, false, u32, b32, r, unsigned, max, maximum_t)
SHFL_OP_MACRO(down, false, u32, b32, r, unsigned, min, minimum_t)

SHFL_OP_MACRO(up, true, f32, b32, f, float, add, plus_t)
SHFL_OP_MACRO(up, true, f32, b32, f, float, max, maximum_t)
SHFL_OP_MACRO(up, true, f32, b32, f, float, max, minimum_t)
SHFL_OP_MACRO(down, false, f32, b32, f, float, add, plus_t)
SHFL_OP_MACRO(down, false, f32, b32, f, float, max, maximum_t)
SHFL_OP_MACRO(down, false, f32, b32, f, float, max, minimum_t)

SHFL_OP_MACRO(up, true, s64, b64, l, int64_t, add, plus_t)
SHFL_OP_MACRO(up, true, s64, b64, l, int64_t, max, maximum_t)
SHFL_OP_MACRO(up, true, s64, b64, l, int64_t, min, minimum_t)
SHFL_OP_MACRO(down, false, s64, b64, l, int64_t, add, plus_t)
SHFL_OP_MACRO(down, false, s64, b64, l, int64_t, max, maximum_t)
SHFL_OP_MACRO(down, false, s64, b64, l, int64_t, min, minimum_t)

SHFL_OP_MACRO(up, true, u64, b64, l, uint64_t, add, plus_t)
SHFL_OP_MACRO(up, true, u64, b64, l, uint64_t, max, maximum_t)
SHFL_OP_MACRO(up, true, u64, b64, l, uint64_t, min, minimum_t)
SHFL_OP_MACRO(down, false, u64, b64, l, uint64_t, add, plus_t)
SHFL_OP_MACRO(down, false, u64, b64, l, uint64_t, max, maximum_t)
SHFL_OP_MACRO(down, false, u64, b64, l, uint64_t, min, minimum_t)

SHFL_OP_MACRO(up, true, f64, b64, d, double, add, plus_t)
SHFL_OP_MACRO(up, true, f64, b64, d, double, max, maximum_t)
SHFL_OP_MACRO(up, true, f64, b64, d, double, min, minimum_t)
SHFL_OP_MACRO(down, false, f64, b64, d, double, add, plus_t)
SHFL_OP_MACRO(down, false, f64, b64, d, double, max, maximum_t)
SHFL_OP_MACRO(down, false, f64, b64, d, double, min, minimum_t)
