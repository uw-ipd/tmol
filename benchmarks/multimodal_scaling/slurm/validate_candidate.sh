#!/usr/bin/env bash
#SBATCH --job-name=tmol-candidate-test
...
#SBATCH --output=/mnt/data/kdidi/tmol-candidate-ab/logs/candidate-test-%j.out
#SBATCH --error=/mnt/data/kdidi/tmol-candidate-ab/logs/candidate-test-%j.err
