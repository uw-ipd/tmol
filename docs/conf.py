...
exclude_patterns = ["apidoc/tmol.rst"]
...
# documentation.
#
html_theme_options = dict(canonical_url="http://tmol.uw.ipd.edu/", display_version=True)
...
latex_documents = [(master_doc, "TMol.tex", "TMol Documentation", "TMol Contributers", "manual")]

# -- Options for manual page output ------------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, "tmol", "TMol Documentation", [author], 1)]
