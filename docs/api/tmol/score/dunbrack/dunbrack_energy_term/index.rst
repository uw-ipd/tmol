tmol.score.dunbrack.dunbrack_energy_term
========================================

.. py:module:: tmol.score.dunbrack.dunbrack_energy_term
...
.. autoapisummary::
   ...
   tmol.score.dunbrack.dunbrack_energy_term.DunbrackBlockAttrs
   tmol.score.dunbrack.dunbrack_energy_term.DunbrackEnergyTerm


Module Contents
---------------

.. py:class:: DunbrackBlockAttrs

   .. py:attribute:: n_dihedrals
      :type:  int


   .. py:attribute:: dih_uaids
      :type:  numpy.ndarray


   .. py:attribute:: rotamer_table_set
      :type:  int


   .. py:attribute:: rotameric_index
      :type:  int


   .. py:attribute:: semirotameric_index
      :type:  int
   ...
   .. py:attribute:: n_rotameric_chi
      :type:  int


   .. py:attribute:: probability_table_offset
      :type:  int


   .. py:attribute:: mean_table_offset
      :type:  int


   .. py:attribute:: rotamer_index_to_table_index_offset
      :type:  int


   .. py:attribute:: semirotameric_tableset_offset
      :type:  int


.. py:class:: DunbrackEnergyTerm(param_db: tmol.database.ParameterDatabase, device: torch.device)
   ...
   .. py:method:: get_torsion(name, block_type)
   ...
   .. py:method:: pack_data_keyed_on_block_type(active_block_types, field_getter, device, default_fill=-1)
