tmol.score.bond_dependent_term
==============================

.. py:module:: tmol.score.bond_dependent_term
...
.. autoapisummary::
   ...
   tmol.score.bond_dependent_term.BondDependentTerm


Module Contents
---------------

.. py:class:: BondDependentTerm(param_db: tmol.database.ParameterDatabase, device: torch.device, **kwargs)
