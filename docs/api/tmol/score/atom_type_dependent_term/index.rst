tmol.score.atom_type_dependent_term
===================================

.. py:module:: tmol.score.atom_type_dependent_term
...
.. autoapisummary::
   ...
   tmol.score.atom_type_dependent_term.AtomTypeDependentTerm


Module Contents
---------------

.. py:class:: AtomTypeDependentTerm(param_db: tmol.database.ParameterDatabase, device: torch.device)
   ...
   .. py:attribute:: np_is_hydrogen
      :type:  tmol.types.array.NDArray[bool]


   .. py:attribute:: np_is_heavyatom
      :type:  tmol.types.array.NDArray[bool]
   ...
   .. py:method:: get_atom_unique_id_name(block_name, atom_name)


   .. py:method:: get_atom_wildcard_id_name(atom_name)
