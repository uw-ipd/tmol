...
EIGEN_DEVICE_FUNC Real lj(Real& dist, const PathLength& bonded_path_length,
                          const Real& lj_sigma, const Real& lj_switch_slope,
                          const Real& lj_switch_intercept,
                          const Real& lj_coeff_sigma12,
                          const Real& lj_coeff_sigma6, const Real& lj_spline_y0,
                          const Real& lj_spline_dy0,
                          const Real& lj_switch_dis2sigma,
                          const Real& spline_start, const Real& max_dis) {
  Real lj = 0.0;
...
d_lj_d_dist(Real& dist, const Int& bonded_path_length, const Real& lj_sigma,
            const Real& lj_switch_slope, const Real& lj_switch_intercept,
            const Real& lj_coeff_sigma12, const Real& lj_coeff_sigma6,
            const Real& lj_spline_y0, const Real& lj_spline_dy0,
            const Real& lj_switch_dis2sigma, const Real& spline_start,
            const Real& max_dis) {
